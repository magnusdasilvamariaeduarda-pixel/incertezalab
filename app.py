...
O MMG IncertezaLab realiza cálculos de incerteza de medição de forma automática.

### Grandeza
Selecione a característica que está sendo medida.

### Unidade
Informe a unidade utilizada na medição.

### Nível de Confiança
Define o fator de cobertura utilizado no cálculo da incerteza expandida.
...
### Certificado
Incerteza proveniente do certificado de calibração.

### Resolução
Menor divisão do instrumento de medição.

### Deriva
Variação do instrumento ao longo do tempo.
...
### Gráfico
Apresenta a contribuição percentual de cada fonte de incerteza.
""")
